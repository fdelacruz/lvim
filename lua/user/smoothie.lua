...
vim.cmd[[
nnoremap <m-j> <cmd>call smoothie#do("\<C-D>") <CR>
vnoremap <m-j> <cmd>call smoothie#do("\<C-D>") <CR>

nnoremap <m-k> <cmd>call smoothie#do("\<C-U>") <CR>
vnoremap <m-k> <cmd>call smoothie#do("\<C-U>") <CR>
]]
